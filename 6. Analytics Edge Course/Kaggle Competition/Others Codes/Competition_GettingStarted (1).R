#My code is quite messy and I apologize for that. Apart from the usual feature engineering 
#(Hour, Weekday, etc. question mark in headline, dollar sign in abstract and headline) doing a wordcounton abstract
#and Headline gave me good results I believe. In addition to that, I searched for various patterns in the 
#headline part ( The weekly segments etc. that keep getting repeated) . I also used Bag of Words
