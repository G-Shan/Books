...
#I count myself among those saved by somewhat less-advanced R skills keeping me from overfitting too much.  
#Ended 97th place after ranking 324th on the public leaderboard, much to my surprise.  
#I think my best approach was an ensemble model weighted mostly to a GBM model based on non-text variables.  
#I didn't fill any blanks as those always lowered my score somehow.
